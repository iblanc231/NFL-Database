...
public class AddDivision extends JPanel {
    ...
    private void initSaveButton(){
        saveButton.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent actionEvent) {
                String newDivision = nameTextField.getText() + " has been added to the database.";
                JOptionPane.showMessageDialog(null, newDivision);
                DivisionApi.saveDivision(new Division(Integer.parseInt(idTextField.getText()), nameTextField.getText(), Integer.parseInt(confTextField.getText())));
            }
        });
    }
}
