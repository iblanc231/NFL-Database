...
public class AddTeam_Owner extends JPanel{
    ...
    private void initSaveButton(){
        saveButton.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent actionEvent) {
                    String newOwner = nameTextField.getText() + " has been added to the database.";
                    JOptionPane.showMessageDialog(null, newOwner);
                    Team_OwnerApi.saveTeam_Owner(new Team_Owner(ssnTextField.getText(),nameTextField.getText(),Integer.parseInt(teamTextField.getText()),Double.parseDouble(netTextField.getText())));
            }
        });
    }
}
