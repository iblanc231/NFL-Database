...
public class AddConference extends JPanel {
    ...
    public AddConference(){
        ...
        private void initSaveButton(){
            saveButton.addActionListener(new ActionListener() {
                ...
                @Override
                public void actionPerformed(ActionEvent actionEvent) {
                    String newConference = nameTextField.getText() + " has been added to the database.";
                    JOptionPane.showMessageDialog(null, newConference);
                    ConferenceApi.saveConference(new Conference(Integer.parseInt(idTextField.getText()), nameTextField.getText()));
                }
            });
        }
    }
