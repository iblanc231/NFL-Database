...
public class AddScout extends JPanel{
    ...
    private void initSaveButton(){
        saveButton.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent actionEvent) {
                    String newScout = nameTextField.getText() + " has been added to the database.";
                    JOptionPane.showMessageDialog(null, newScout);
                    ScoutApi.saveScout(new Scout(ssnTextField.getText(),nameTextField.getText(),agencyTextField.getText()));
            }
        });
    }
}
